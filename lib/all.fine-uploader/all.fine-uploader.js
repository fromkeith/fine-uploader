...
(function(global) {
    ...
    qq.s3.RequestSignerWorkerManager = function(o) {
        "use strict";
        var worker = null, workerPromises = {}, options = {
            workerUrl: null,
            log: function(str, level) {}
        };
        qq.extend(options, o, true);
        function init() {
            ...
            try {
                ...
                worker.onerror = function(e) {
                    ...
                    worker = null;
                    var outstandingRequests = Object.keys(workerPromises), i;
    ...
    qq.s3.RequestSigner = function(o) {
        ...
        function handleSignatureReceived(id, xhrOrXdr, isError) {
            var responseJson = xhrOrXdr.responseText, pendingSignatureData = pendingSignatures[id], promise, signatureConstructor, errorMessage, response;

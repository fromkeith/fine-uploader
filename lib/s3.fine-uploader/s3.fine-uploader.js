...
(function(global) {
    ...
    qq.s3.RequestSignerWorkerManager = function(o) {
        "use strict";
        var _worker = null, _workerPromises = {}, options = {
            workerUrl: null,
            log: function(str, level) {}
        };
        qq.extend(options, o, true);
        function init() {
            ...
            try {
                ...
                _worker.onerror = function(e) {
                    ...
                    _worker = null;
                    var outstandingRequests = Object.keys(_workerPromises), i;
        ...
        this.generateSignature = function(file) {
            ...
            var promise = new qq.Promise(), task = {
                file: file,
                id: qq.getUniqueId()
            };
    ...
    qq.s3.RequestSigner = function(o) {
        ...
        var requester, thisSignatureRequester = this, pendingSignatures = {}, options = {
            ...
            log: function(str, level) {}
        }, credentialsProvider, workerManager, generateHeaders = function(signatureConstructor, signature, promise) {
